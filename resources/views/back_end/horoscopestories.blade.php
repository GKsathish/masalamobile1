                 ...
                 <div class="page-title-box">
                   <div class="row align-items-center">
                       ...
                       <div class="col-sm-6 text-right">
                           ...
                           <button class="btn btn-info" onclick="window.location.href='{{url('add_mainhoro')}}'"  type="button"><i class="fa fa-plus" aria-hidden="true"></i> Add New</button>
                       </div>
                       @endif
                               ...
                               <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                   ...
                                   <tbody>
                                       @php 
                                        ...
                                        $info = DB::table('H_stories')
                                               ->join('category', 'category.categoryid', '=', 'H_stories.categoryid')
                                               ->Orderby('H_stories.storyid', 'desc')                                          
                                               ->get(); 
                                             @endphp
                                       <?php $i = 1; ?>
                                          @foreach ($info as $row)
                                           <tr style="text-align:center">
                                               ...
                                               <td> -->
                                                   ...
                                                   <a href="add_inlinehoro&id={{$row->storyid}}"><span class="badge badge-pill badge-success">Click Here</span></a>
                                                   @endif
                                               ...
                                               <td><a href="horoscopestories&id={{$row->storyid}}" class="btn btn-success" target="_blank" ><i class="fa fa-eye" aria-hidden="true"></i></a></td> 
       
                                               <td>
                                                   @if($vs_permit_edit == '1' || $roleid == '0')
                                                   <a  href="edit_stories?storyid={{$row->storyid}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                   @endif
                                                   &nbsp;&nbsp;
