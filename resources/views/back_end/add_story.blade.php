                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label>Story Description</label>
                         <textarea id="" class="form-control summernote" name="storydesc[]" rows="4" cols="50"></textarea> 
                        <!--<textarea class="summernote" name="storydesc[]"></textarea>-->
                        <!-- <input type="text" class="form-control" required placeholder="Enter Story Description" name="storydesc[]"> -->
                    </div>
                                    ...
                                    <?php $i = 1; ?>
                                       @foreach ($storytrans as $row)
                                        <tr style="text-align:center">
                                            ...
                                            <td><a href="delete_stories&transid={{$row->transid}}&storyid={{$row->storyid}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
