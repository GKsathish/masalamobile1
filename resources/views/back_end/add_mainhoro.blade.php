        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <!--                    <textarea class="summernote" name="sdescription"></textarea>-->
                                         <textarea class="form-control " required placeholder="Enter Story Description" name="sdescription"  > </textarea>
