            ...
            <div class="sidebarposts clear">
                ...
                <div id="Recent" class="tabcontent clear">
                    <ul>
                        ...
                        ?>
                        @php
                        $entertainmentinfo = DB::table('paparazzi_post')->where('status','Publish')->orderBy('published_date','desc')->skip(4)->take(6)->get();
                        @endphp
                ...
                <div id="Popular" class="tabcontent clear">
                    <ul>
                        @php
                        $entertainmentinfo = DB::table('paparazzi_post')->whereRaw('DATE(published_date) >= DATE_SUB(CURDATE(), INTERVAL 6 DAY)')->where('hitcount', '>',0)->where('status','Publish')->take(6)->orderBy('hitcount','desc')->get();
                        @endphp
                        @foreach($entertainmentinfo as $entertainmentinfo)
                        <li>
                            <a href="paparazzi-post&id={{$entertainmentinfo->postid}}">
