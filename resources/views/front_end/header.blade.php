...
<head>
   ...
   const firebaseConfig = {
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-KX27D98');
    </script>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:900px) {
            ...
            .dropd:hover .dropdcontent1 {
                display: block;
            }

            .dropd:hover .dropdbtn1 {
                background-color: #a83299;
            }
        }
    </style>
...
<body>
    ...
    <div class="Bi-model">
        <div class="Bi-model-box">
            ...
            <div class="Bi-form">
                ...
                <center>
                    <h3>Subscribe to alerts and updates</h3>
                </center>
    ...
    text-align: center;">Please enter you Gmail</p>
                    <div class="bi-formdata" style="    margin: 0;">
                        <input type="checkbox" name="terms" class="term" Checked>
                        <p class="terms">I have read and agree to the <a href="https://mobilemasala.com/terms-of-use">terms of use</a> and <span class="more">More...</span>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KX27D98" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div class="wrapper">
        <header class="site-header clear">
            ...
            <p class="bell2"><i class="fa fa-bell"></i></p>
