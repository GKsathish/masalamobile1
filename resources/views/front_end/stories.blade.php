...
{
	content:''; width:54px; 
	height:1px; background-color:#fff; position:absolute; left:50%; bottom:0; transform:translateX(-100%);}
...
/*.summary{text-align:center; color:#fff; line-height:1.41; letter-spacing:1px; font-size:16px; padding:0 0 15px; font-family:'Montserrat', sans-serif; }*/
.summary.summary-shiftup{margin-bottom:5px;}
...
.inner-align-end-next .summary { font-size:16px; text-align:center; }
.para{
    color:#fff;
    text-align:center;
   	border-top-left-radius: 50% 75px;
...
<!--    <a href="https://www.mobilemasala.com" title="Link Description"></a>-->
