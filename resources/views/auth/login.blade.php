...
<head>
        <meta charset="utf-8" />
        <title>Mobile Masala - Login</title>
...
<link href="assets/css/style.css" rel="stylesheet" type="text/css" />
    ...
    <body class="pb-0">
        ...
        <div class="wrapper-page ">
            ...
            <div class="card" style="box-shadow: 0px 22px 36px rgb(0 0 0 / 20%);">
                <div class="card-body"> 

                    <div class="p-3">
                        <h4 class="font-18 m-b-5 text-center">Welcome Back !</h4>   <br/>
                  ...
                  @if (\Session::has('success2'))
                        ...
                        <form class="form-horizontal m-t-30" action="login_process" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="email" class="form-control" name="email" id="email" required autocomplete="email" autofocus placeholder="Enter Username">
                            </div>

                            <div class="form-group">
                                <label for="userpassword">Password</label>
                                <input type="password" class="form-control" name="password" id="password" required autocomplete="current-password" placeholder="Enter Password">
                            </div>
            ...
            <div class="m-t-40 text-center">
                ...
                <p>© <?php echo date('Y'); ?> Mobile Masala.</p>
            </div>
        </div>
        <!-- end wrapper-page -->
        <!-- App's Basic Js  -->
